...
// Scene Presets
// Model style presets — relaxed jawline, natural closed lips without tension, effortless lookbook posture
const MODEL_STYLES = {
  classic: {
    name: '高级名模',
    female: 'with high-fashion editorial elegance, chiseled serene facial features, calm composed gaze, naturally closed lips without tension, relaxed natural jawline, and effortless lookbook poise',
    male: 'with sharp defined jawline, European high-fashion charisma, calm composed gaze, naturally closed lips without tension, relaxed jawline, and natural confident posture'
  },
  sweet: {
    name: '甜美清新',
    female: 'with clean youthful aesthetic, gentle refined facial features, tranquil poise, naturally closed lips without tension, relaxed natural jawline, and tender serene gaze',
    male: 'with clean youthful Korean lookbook charm, refined gentle features, relaxed natural poise, naturally closed lips without tension, and subtle calm gaze'
  },
  athletic: {
    name: '运动活力',
    female: 'with healthy athletic glow, tone-defined posture, calm focused expression, naturally closed lips without tension, relaxed natural jawline, and confident grounded stance',
    male: 'with athletic toned build, sharp defined facial structure, calm focused gaze, naturally closed lips without tension, and upright confident stance'
  },
  mature: {
    name: '成熟御姐',
    female: 'with sophisticated executive poise, graceful mature facial structure, naturally closed lips without tension, relaxed natural jawline, and commanding serene presence',
    male: 'with distinguished mature charisma, sharp masculine features, naturally closed lips without tension, and commanding executive posture'
  },
  cool: {
    name: '中性酷感',
    female: 'with modern androgynous edge, chic understated attitude, sharp bone structure, naturally closed lips without tension, relaxed natural jawline, and effortless lookbook poise',
...
const SCENES = {
  street: {
    ...
    buildPrompts: (gender = 'female', custom = '', _customScene = '', style = 'classic', customStylePrompt = '') => {
      const isM = gender === 'male';
      const subj = styledSubject(gender, style, 'stylish female model', 'handsome male model', customStylePrompt);
      const pro = isM ? 'he' : 'she';
      const pos = isM ? 'his' : 'her';
      const extra = custom ? `, ${custom}` : '';
      return {
        krea_prompt: `a ${subj} standing full-length on a sunlit city street sidewalk with historic brownstone buildings, transfer the outfit, full body editorial fashion lookbook photography, head-to-toe framed with complete shoes and feet firmly planted on concrete sidewalk with realistic soft ground contact shadows beneath footwear, arms resting naturally at sides with subtle organic elbow curvature, hands relaxed and fully visible with five natural fingers, subtle natural weight shift, serene composed expression, naturally closed lips without tension, relaxed jawline, natural directional sunlight casting soft ground shadows, authentic human skin texture with visible natural pores, fine skin lines, subtle peach fuzz, natural skin sheen, realistic subsurface scattering, natural catchlights in the eyes, tactile fabric weave and seam details, shot on 35mm lens, f/2.8, subtle organic film grain${extra}`,
        seg1_prompt: `A commercial lookbook fashion video faithful to the reference image: the identical ${subj} wearing the exact outfit from the reference image. Steady gimbal tracking shot at eye level: ${pro} takes slow, measured runway strides forward toward the camera along a sunlit urban asphalt sidewalk (1 step per second), shoes maintaining firm traction on the pavement with natural step-and-plant walking mechanics, zero sliding, arms swaying organically at sides with relaxed open hands. Calm composed lookbook expression with naturally closed lips without tension, subtle relaxed facial features. Natural fabric and leather drape and garment movement swaying organically with each step. Constant directional daylight, authentic textile details, soft circular background bokeh, stable camera framing${extra}.\n\nAudio: distant muffled city traffic hum, crisp footsteps on asphalt sidewalk, subtle soft rustle of clothing fabric swaying as ${pro} walks.`,
        seg2_prompt: `Continuing seamlessly from the previous walk: the same ${subj} in the identical outfit slows ${pos} stride, executing a smooth grounded 45-degree exhibition turn to showcase the side silhouette, drape, and rear tailoring of the clothing, feet firmly planted with natural pivot mechanics, glancing casually toward the lens with a calm serene expression and naturally closed lips without tension. Steady slow 35mm camera pan capturing leather grain, fabric stitching, garment folds, and clean hemlines. Constant natural sunlight, warm city background bokeh, stable facial features, stable anatomy${extra}.\n\nAudio: continuous city ambient background, soft shoe pivot on pavement, quiet fabric flutter, gentle outdoor breeze.`
      };
    }
  },
  studio: {
    ...
    buildPrompts: (gender = 'female', custom = '', _customScene = '', style = 'classic', customStylePrompt = '') => {
      ...
      const extra = custom ? `, ${custom}` : '';
      return {
        krea_prompt: `a professional ${subj} standing full-length in a clean minimalist studio against a neutral grey cyclorama backdrop, transfer the outfit, full body commercial catalogue lookbook photography, head-to-toe framed with complete shoes and feet firmly planted on matte studio floor with realistic soft ground contact shadows beneath footwear, arms resting naturally at sides with subtle organic elbow curvature, hands relaxed and fully visible with five natural fingers, subtle natural weight shift, serene composed editorial expression, naturally closed lips without tension, relaxed jawline, diffuse softbox studio lighting, authentic human skin texture with visible natural pores, fine skin lines, subtle peach fuzz, natural skin sheen, realistic subsurface scattering on cheeks, natural catchlights in the eyes, tactile cloth texture and seam details, shot on 50mm lens, subtle organic film grain, soft contact shadows${extra}`,
        seg1_prompt: `A commercial lookbook fashion video faithful to the reference image: the identical ${subj} wearing the exact outfit from the reference image, situated against a neutral grey cyclorama studio backdrop. Smooth motorized camera dolly tracking backward at eye level: ${pro} takes slow, deliberate runway steps forward, shoes maintaining firm traction on the studio floor with natural step-and-plant walking mechanics, zero sliding, arms swaying organically at sides with relaxed open hands, with calm poise and naturally closed lips without tension. Clean garment tailoring, natural cloth and leather physics, natural weave texture and subtle film grain, zero shadow pulsing. Dual softbox studio illumination with soft natural falloff${extra}.\n\nAudio: dead-quiet soundproof studio room tone, soft rhythmic footsteps on floor, subtle tactile rustle of garment cloth swaying.`,
        seg2_prompt: `Continuing seamlessly from the previous walk: the same ${subj} in the identical outfit smoothly slows ${pos} cadence and executes an elegant grounded 45-degree exhibition turn, feet firmly planted with natural pivot mechanics, allowing the camera to inspect the side silhouette, collar construction, and rear garment cut, pausing with serene poise and naturally closed lips without tension. Tripod steady framing, softbox studio lighting with gentle shadow falloff, authentic catalogue aesthetic, stable facial features, stable anatomy${extra}.\n\nAudio: quiet soundproof studio room tone, soft shoe pivot on floor, quiet whisper of moving garment fabric.`
      };
    }
  },
  office: {
    ...
    sceneEnvironment: 'in the grand entrance lobby of a modern glass corporate skyscraper with matte-finished granite flooring, morning architectural sunlight filtering through high glass curtain walls',
    buildPrompts: (gender = 'female', custom = '', _customScene = '', style = 'classic', customStylePrompt = '') => {
      const isM = gender === 'male';
      const subj = styledSubject(gender, style, 'chic business professional woman', 'professional businessman', customStylePrompt);
      const pro = isM ? 'he' : 'she';
      const pos = isM ? 'his' : 'her';
      const extra = custom ? `, ${custom}` : '';
      return {
        krea_prompt: `a ${subj} standing full-length in the grand entrance lobby of a modern glass corporate skyscraper with matte-finished granite flooring, transfer the outfit, full body executive lookbook photography, head-to-toe framed with complete shoes and feet firmly planted with realistic soft ground contact shadows beneath footwear and subtle diffuse ambient floor sheen, arms resting naturally at sides with subtle organic elbow curvature, hands relaxed and fully visible with five natural fingers, subtle natural weight shift, composed executive poise, naturally closed lips without tension, relaxed jawline, morning architectural sunlight filtering through high glass curtain walls, authentic human skin texture with visible natural pores, fine skin lines, subtle peach fuzz, natural skin sheen, realistic subsurface scattering, natural catchlights in the eyes, tactile leather grain and fabric drape, shot on 35mm lens, subtle organic film grain${extra}`,
        seg1_prompt: `A commercial career lookbook video faithful to the reference image: the identical ${subj} wearing the exact outfit from the reference image walking forward through the spacious lobby of a glass corporate skyscraper. Smooth forward tracking shot at eye level: ${pro} walks with confident upright posture, shoes maintaining firm traction on the floor with natural step-and-plant walking mechanics, zero sliding, arms swaying organically at sides with relaxed open hands, and a calm composed expression with naturally closed lips without tension. Morning sunbeams filtering diagonally through high glass windows, casting soft architectural light across the matte granite floor. Crisp garment lines, natural fabric movement${extra}.\n\nAudio: spacious architectural glass lobby ambiance, subtle acoustic reverberation, crisp confident footsteps echoing gently on floor.`,
        seg2_prompt: `Continuing seamlessly from the previous walk: the same ${subj} in the identical outfit halts smoothly near a glass architectural handrail overlooking the skyline, executing a grounded 45-degree turn with feet firmly planted to reveal the tailored silhouette, leather grain, back seam construction, and garment drape. ${pro} glances toward the lens with a composed confident expression and naturally closed lips without tension. Steady slow camera glide, constant natural morning illumination, stable facial features, stable anatomy${extra}.\n\nAudio: tranquil glass lobby atmosphere, soft shoe step, quiet fabric motion, distant muted indoor reverberation.`
      };
    }
  },
  boutique: {
    ...
    sceneEnvironment: 'in a luxury designer concept boutique with honed Italian marble floors and minimalist brass fixtures, warm 3200K architectural recessed spotlights',
    buildPrompts: (gender = 'female', custom = '', _customScene = '', style = 'classic', customStylePrompt = '') => {
      const isM = gender === 'male';
      const subj = styledSubject(gender, style, 'elegant female fashion model', 'confident refined male model', customStylePrompt);
      const pro = isM ? 'he' : 'she';
      const pos = isM ? 'his' : 'her';
      const extra = custom ? `, ${custom}` : '';
      return {
        krea_prompt: `a ${subj} standing full-length in a luxury designer concept boutique with honed Italian marble floors and minimalist brass fixtures, transfer the outfit, full body luxury retail lookbook photography, head-to-toe framed with complete shoes and feet firmly planted with realistic soft ground contact shadows beneath footwear and subtle diffuse floor sheen, arms resting naturally at sides with subtle organic elbow curvature, hands relaxed and fully visible with five natural fingers, subtle natural weight shift, serene composed gaze, naturally closed lips without tension, relaxed jawline, warm 3200K architectural recessed spotlights with soft falloff, authentic human skin texture with visible natural pores, fine skin lines, subtle peach fuzz, natural skin sheen, realistic subsurface scattering, natural catchlights in the eyes, tactile fabric weave and leather grain, shot on 35mm lens, subtle organic film grain${extra}`,
        seg1_prompt: `A luxury retail commercial lookbook video faithful to the reference image: the identical ${subj} wearing the exact outfit from the reference image in a lavish warm-toned concept boutique with honed Italian marble floors. Smooth camera glide tracking backward at eye level: ${pro} walks gracefully forward, shoes maintaining firm traction on the floor with natural step-and-plant walking mechanics, zero sliding, arms swaying organically at sides with relaxed open hands, a calm composed expression and naturally closed lips without tension. Warm 3200K architectural spotlights gently grazing fabric textures and clean seams. Fluid motion, perfectly locked anatomy, elegant posture${extra}.\n\nAudio: luxurious quiet boutique interior ambiance, subtle acoustic reverberation, crisp rhythmic footsteps clicking gently on honed marble floor, soft silky cloth rustle.`,
        seg2_prompt: `Continuing seamlessly from the previous walk: the same ${subj} in the identical outfit gently pauses beside an architectural display plinth, executing a grounded 45-degree exhibition turn with feet firmly planted to showcase the garment silhouette, seam tailoring, and textile craftsmanship. Smooth slow camera pan highlighting the neckline, leather grain, fabric weave, and rear cut. Composed poised lookbook expression, naturally closed lips without tension, constant warm 3200K architectural spotlighting, creamy background bokeh, stable anatomy${extra}.\n\nAudio: warm boutique interior ambiance, gentle soft reverberation, soft shoe pivot on marble, quiet fabric glide.`
      };
    }
  },
  outdoor: {
    ...
    buildPrompts: (gender = 'female', custom = '', _customScene = '', style = 'classic', customStylePrompt = '') => {
      const isM = gender === 'male';
      const subj = styledSubject(gender, style, 'natural female fashion model', 'athletic relaxed male model', customStylePrompt);
      const pro = isM ? 'he' : 'she';
      const pos = isM ? 'his' : 'her';
      const extra = custom ? `, ${custom}` : '';
      return {
        krea_prompt: `a ${subj} standing full-length in a lush sun-dappled botanical garden along a smooth stone paver pathway, blooming foliage, transfer the outfit, full body lifestyle lookbook photography, head-to-toe framed with complete shoes and feet firmly planted on stone pavers with realistic soft ground contact shadows beneath footwear, arms resting naturally at sides with subtle organic elbow curvature, hands relaxed and fully visible with five natural fingers, subtle natural weight shift, peaceful serene expression, naturally closed lips without tension, relaxed jawline, natural outdoor daylight, soft dappled sunlight, authentic human skin texture with visible natural pores, fine skin lines, subtle peach fuzz, natural skin sheen, realistic subsurface scattering, natural catchlights in the eyes, tactile cloth folds and texture, shot on 35mm lens, subtle organic film grain${extra}`,
        seg1_prompt: `An outdoor lifestyle fashion lookbook video faithful to the reference image: the identical ${subj} wearing the reference clothing walks forward along a sun-dappled stone path through a lush green park. Steady forward tracking gimbal camera: ${pro} walks at a relaxed natural cadence, shoes maintaining firm traction on the stone pavers with natural step-and-plant walking mechanics, zero sliding, arms swaying organically at sides with relaxed open hands, with a calm serene expression and naturally closed lips without tension. Sunlight filtering through tree canopies creating gentle dappled patterns across the clothing. Natural cloth and leather physics swaying softly in the fresh outdoor breeze${extra}.\n\nAudio: gentle outdoor breeze rustling green tree leaves, peaceful distant birdsong, soft footsteps on stone pavers, subtle cloth rustle.`,
        seg2_prompt: `Continuing seamlessly from the previous walk: the same ${subj} in the identical outfit pauses beside blooming greenery, turning smoothly 45 degrees with grounded footing to showcase the garment movement, leather grain, fabric drape, and seam tailoring. Serene gentle gaze, naturally closed lips without tension, natural directional sunlight filtered through tree canopies creating a soft rim light on ${pos} silhouette and garment edges. Steady camera pan, stable facial features, stable anatomy${extra}.\n\nAudio: continuous tranquil birdsong, gentle outdoor wind gust, soft stone step, crisp fabric flutter in the breeze.`
      };
    }
  },
  cafe: {
    ...
    buildPrompts: (gender = 'female', custom = '', _customScene = '', style = 'classic', customStylePrompt = '') => {
      const isM = gender === 'male';
      const subj = styledSubject(gender, style, 'stylish young woman', 'stylish young man', customStylePrompt);
      const pro = isM ? 'he' : 'she';
      const pos = isM ? 'his' : 'her';
      const extra = custom ? `, ${custom}` : '';
      return {
        krea_prompt: `a ${subj} standing full-length in a cozy Nordic-aesthetic cafe with warm timber oak interiors and large floor-to-ceiling sunlit windows, transfer the outfit, full body cozy editorial lookbook photography, head-to-toe framed with complete shoes and feet firmly planted on hardwood floor with realistic soft ground contact shadows beneath footwear, arms resting naturally at sides with subtle organic elbow curvature, hands relaxed and fully visible with five natural fingers, subtle natural weight shift, relaxed serene expression, naturally closed lips without tension, relaxed jawline, warm natural window light with soft interior fill, authentic human skin texture with visible natural pores, fine skin lines, subtle peach fuzz, natural skin sheen, realistic subsurface scattering, natural catchlights in the eyes, tactile knit and fabric weave, shot on 35mm lens, subtle organic film grain${extra}`,
        seg1_prompt: `A cozy lifestyle fashion lookbook video faithful to the reference image: the identical ${subj} wearing the exact outfit walks forward with natural poise in an aesthetic Nordic-style cafe near sunlit floor-to-ceiling windows. Smooth eye-level gimbal tracking shot: ${pro} walks at a relaxed pace, shoes maintaining firm traction on the wood floor with natural step-and-plant walking mechanics, zero sliding, arms swaying organically at sides with relaxed open hands, a calm peaceful expression and naturally closed lips without tension. Warm timber tones, soft ambient lighting, natural garment drape swaying gently${extra}.\n\nAudio: quiet ambient cafe murmur in the far background, distant gentle hiss of espresso machine steam, soft footsteps on hardwood timber floor, quiet fabric rustle.`,
        seg2_prompt: `Continuing seamlessly from the previous walk: the same ${subj} in the identical outfit pauses beside the sunlit window, executing a grounded 45-degree turn with feet firmly planted to reveal the garment silhouette, leather grain, back tailoring, and fabric weave. Smooth camera pan highlighting the collar line, pocket details, and cloth texture. Calm peaceful expression, naturally closed lips without tension, warm daylight, soft progressive background falloff, stable anatomy${extra}.\n\nAudio: gentle cafe room tone, quiet atmospheric background murmur, soft shoe step on wood floor, subtle fabric rustle.`
      };
    }
  },
  custom: {
    ...
    buildPrompts: (gender = 'female', customPrompt = '', customScene = '', style = 'classic', customStylePrompt = '') => {
      ...
      const pro = isM ? 'he' : 'she';
      const pos = isM ? 'his' : 'her';
      const rawScene = (customScene && customScene.trim()) ? customScene.trim() : 'an authentic editorial fashion lookbook background';
      const sceneDesc = /^(in|on|at|against|under|near|along)\s+/i.test(rawScene)
        ? rawScene
        : `in ${rawScene}`;
      const extra = customPrompt ? `, ${customPrompt}` : '';
      return {
        krea_prompt: `a ${subj} standing full-length ${sceneDesc}, transfer the outfit, full body editorial lookbook photography, head-to-toe framed with complete shoes and feet firmly planted on ground with realistic soft ground contact shadows beneath footwear, arms resting naturally at sides with subtle organic elbow curvature, hands relaxed and fully visible with five natural fingers, subtle natural weight shift, serene composed expression, naturally closed lips without tension, relaxed natural jawline, elegant confident posture, realistic lighting consistent with the environment, authentic human skin texture with visible natural pores, fine skin lines, subtle peach fuzz, natural skin sheen, realistic subsurface scattering, natural catchlights in the eyes, tactile fabric weave and seam details, shot on 35mm lens, subtle organic film grain${extra}`,
        seg1_prompt: `A commercial lookbook fashion showcase video faithful to the reference image: the ${subj} wearing the identical outfit, situated ${sceneDesc}. Smooth steady gimbal tracking shot at eye level: ${pro} walks forward at a measured natural cadence, shoes maintaining firm traction on the ground with natural step-and-plant walking mechanics, zero sliding, arms swaying organically at sides with relaxed open hands, with calm confidence and naturally closed lips without tension toward the lens. Fabric drape, leather grain, and textile weave clearly visible, natural organic cloth physics. Natural ambient lighting consistent with the environment${extra}.\n\nAudio: natural atmospheric ambiance matching the acoustic surroundings, subtle rhythmic footsteps, soft fabric rustle as ${pro} moves.`,
        seg2_prompt: `Continuing seamlessly from the previous shot: the same ${subj} in the identical outfit situated ${sceneDesc} slows ${pos} stride and executes a grounded 45-degree exhibition turn with feet firmly planted to showcase the silhouette, fabric flow, leather grain, and rear tailoring of the clothing, pausing naturally with a calm composed glance toward the lens, naturally closed lips without tension, and serene poise. Steady smooth camera pan revealing fabric weave and flow. Harmonious natural lighting, natural textile details, stable facial features, stable anatomy${extra}.\n\nAudio: continuous atmospheric ambient background, gentle fabric movement sound, subtle environmental breeze.`
      };
    }
  }
};
  ...
  try {
    ...
    if (task.model_image) {
      ...
      if (fs.existsSync(srcModelPath)) {
        ...
        kreaWf['9']['inputs']['prompt'] = `transfer the clothing and outfit from the first reference image onto the ${modelGenderLabel} in the second reference image, strictly preserving their exact facial features, facial identity, eye shape, nose shape, and hairstyle, full body editorial lookbook photography, head-to-toe framed with complete shoes and feet firmly planted on ground with realistic soft ground contact shadows beneath footwear, arms resting naturally at sides with subtle organic elbow curvature, hands relaxed and fully visible with five natural fingers, subtle natural weight shift, standing ${sceneEnv}, serene composed expression, naturally closed lips without tension, relaxed jawline, authentic human skin texture with visible natural pores, fine skin lines, subtle peach fuzz, natural skin sheen, realistic subsurface scattering, natural catchlights in the eyes, tactile fabric weave and seam details, shot on 35mm lens, subtle organic film grain${cleanCustom ? ', ' + cleanCustom : ''}`;
      }
      ...
      if (fs.existsSync(srcScenePath)) {
        ...
        kreaWf['9']['inputs']['prompt'] = `a ${subj} standing full-length in the background environment from the first reference image, wearing the exact clothing and outfit from the second reference image, full body editorial lookbook photography, head-to-toe framed with complete shoes and feet firmly planted on ground with realistic soft ground contact shadows beneath footwear, arms resting naturally at sides with subtle organic elbow curvature, hands relaxed and fully visible with five natural fingers, subtle natural weight shift, serene composed expression, naturally closed lips without tension, relaxed jawline, realistic illumination matched to the background environment, authentic human skin texture with visible natural pores, fine skin lines, subtle peach fuzz, natural skin sheen, realistic subsurface scattering, natural catchlights in the eyes, tactile fabric weave and seam details, shot on 35mm lens, subtle organic film grain${cleanCustom ? ', ' + cleanCustom : ''}`;
      }
    }
