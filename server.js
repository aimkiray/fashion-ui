...
const SCENES = {
  street: {
    ...
    buildPrompts: (gender = 'female', custom = '', _customScene = '', style = 'classic') => {
      ...
      return {
        krea_prompt: `a stunning ${subj} standing full-length on a sunlit city street sidewalk with historic brownstone buildings, transfer the outfit, full body commercial lookbook photography, head-to-toe framed with complete shoes and feet in view, both arms straight down relaxed naturally at sides, both hands open and fully visible with natural five fingers clearly shown on each hand, serene composed expression, closed lips, natural directional sunlight casting soft ground shadows, crisp leather grain and fabric texture, ultra sharp focus, pristine commercial photography${extra}`,
  ...
  studio: {
    ...
    buildPrompts: (gender = 'female', custom = '', _customScene = '', style = 'classic') => {
      ...
      const extra = custom ? `, ${custom}` : '';
      return {
        krea_prompt: `a professional ${subj} standing full-length in a clean minimalist studio against a neutral grey cyclorama backdrop, transfer the outfit, full body commercial catalogue lookbook photography, head-to-toe framed with complete shoes and feet in view, both arms straight down relaxed naturally at sides, both hands open and fully visible with natural five fingers clearly shown on each hand, serene composed editorial expression, closed lips, diffuse softbox studio lighting, crisp leather grain and fabric texture, ultra sharp focus, pristine commercial photography${extra}`,
  ...
  office: {
    ...
    buildPrompts: (gender = 'female', custom = '', _customScene = '', style = 'classic') => {
      ...
      const extra = custom ? `, ${custom}` : '';
      return {
        krea_prompt: `a ${subj} standing full-length in the grand entrance lobby of a modern glass corporate skyscraper, polished granite floors, transfer the outfit, full body commercial lookbook photography, head-to-toe framed with complete shoes and feet in view, both arms straight down relaxed naturally at sides, both hands open and fully visible with natural five fingers clearly shown on each hand, composed executive poise, closed lips, morning architectural sunlight filtering through high glass curtain walls, crisp leather grain and fabric texture, ultra sharp focus, pristine commercial photography${extra}`,
  ...
  boutique: {
    ...
    buildPrompts: (gender = 'female', custom = '', _customScene = '', style = 'classic') => {
      ...
      const extra = custom ? `, ${custom}` : '';
      return {
        krea_prompt: `a ${subj} standing full-length in a luxury designer concept boutique with polished Italian marble floors and minimalist brass fixtures, transfer the outfit, full body commercial lookbook photography, head-to-toe framed with complete shoes and feet in view, both arms straight down relaxed naturally at sides, both hands open and fully visible with natural five fingers clearly shown on each hand, serene glamorous gaze, closed lips, warm 3200K architectural recessed spotlights, high-end retail aesthetic, crisp leather grain and fabric texture, ultra sharp focus, pristine commercial photography${extra}`,
  ...
  outdoor: {
    ...
    buildPrompts: (gender = 'female', custom = '', _customScene = '', style = 'classic') => {
      ...
      const extra = custom ? `, ${custom}` : '';
      return {
        krea_prompt: `a ${subj} standing full-length in a lush sun-dappled botanical garden along a smooth stone paver pathway, blooming foliage, transfer the outfit, full body commercial lifestyle lookbook photography, head-to-toe framed with complete shoes and feet in view, both arms straight down relaxed naturally at sides, both hands open and fully visible with natural five fingers clearly shown on each hand, peaceful serene expression, closed lips, natural outdoor daylight, dappled sunbeam highlights, crisp leather grain and fabric texture, ultra sharp focus, pristine commercial photography${extra}`,
  ...
  cafe: {
    ...
    buildPrompts: (gender = 'female', custom = '', _customScene = '', style = 'classic') => {
      ...
      const extra = custom ? `, ${custom}` : '';
      return {
        krea_prompt: `a ${subj} standing full-length in a cozy Nordic-aesthetic cafe with warm timber oak interiors and large floor-to-ceiling sunlit windows, transfer the outfit, full body editorial lookbook photography, head-to-toe framed with complete shoes and feet in view, both arms straight down relaxed naturally at sides, both hands open and fully visible with natural five fingers clearly shown on each hand, relaxed serene expression, closed lips, warm natural daylight and soft interior fill, crisp leather grain and fabric texture, ultra sharp focus, pristine commercial photography${extra}`,
  ...
  custom: {
    ...
    buildPrompts: (gender = 'female', customPrompt = '', customScene = '', style = 'classic') => {
      ...
      return {
        krea_prompt: `a ${subj} standing full-length in ${sceneDesc}, transfer the outfit, full body commercial lookbook photography, head-to-toe framed with complete shoes and feet in view, both arms straight down relaxed naturally at sides, both hands open and fully visible with natural five fingers clearly shown on each hand, serene composed expression, closed lips, elegant confident posture, cinematic lighting consistent with the environment, sharp textile and leather craftsmanship details, ultra sharp focus, pristine commercial photography${extra}`,
  ...
  try {
    ...
    if (task.model_image) {
      ...
      if (fs.existsSync(srcModelPath)) {
        ...
        kreaWf['8']['inputs']['ref_boost'] = 1.05;
        ...
        const sceneEnv = (task.scene.id === 'custom' && cleanCustomScene)
          ? `in ${cleanCustomScene}, cinematic lighting consistent with the environment`
          : (task.scene.sceneEnvironment || 'in a stunning commercial fashion lookbook background, natural commercial lighting');
        const modelGenderLabel = task.gender === 'male' ? 'male model' : 'female model';
        kreaWf['9']['inputs']['prompt'] = `transfer the clothing and outfit from the first reference image onto the ${modelGenderLabel} in the second reference image, strictly preserving their exact facial features, facial identity, eye shape, nose shape, and hairstyle, full body commercial lookbook photography, head-to-toe framed with complete shoes and feet in view, both arms straight down relaxed naturally at sides, both hands open and fully visible with natural five fingers clearly shown on each hand, standing ${sceneEnv}, serene composed expression, closed lips, crisp leather grain and fabric texture, ultra sharp focus, pristine commercial photography${cleanCustom ? ', ' + cleanCustom : ''}`;
      }
      ...
      if (fs.existsSync(srcScenePath)) {
        ...
        kreaWf['9']['inputs']['prompt'] = `a stunning ${subj} standing full-length in the background environment from the first reference image, wearing the exact clothing and outfit from the second reference image, full body commercial lookbook photography, head-to-toe framed with complete shoes and feet in view, both arms straight down relaxed naturally at sides, both hands open and fully visible with natural five fingers clearly shown on each hand, serene composed expression, closed lips, lighting matched to the background environment, crisp leather grain and fabric texture, ultra sharp focus, pristine commercial photography${cleanCustom ? ', ' + cleanCustom : ''}`;
      }
    }
