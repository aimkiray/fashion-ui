...
const MODEL_STYLES = {
  classic: {
    name: '高级名模',
    female: 'with high-fashion editorial elegance, chiseled serene facial features, calm composed gaze, mouth closed, softly closed lips, and regal lookbook posture',
    male: 'with sharp defined jawline, European high-fashion charisma, calm composed gaze, mouth closed, closed lips, and natural upright posture'
  },
  sweet: {
    name: '甜美清新',
    female: 'with clean youthful aesthetic, gentle refined facial features, tranquil poise, mouth closed, softly closed lips, and tender natural gaze',
    male: 'with clean youthful Korean lookbook charm, refined gentle features, relaxed natural poise, mouth closed, closed lips, and subtle serene gaze'
  },
  athletic: {
    name: '运动活力',
    female: 'with healthy athletic glow, tone-defined posture, calm focused expression, mouth closed, closed lips, and confident grounded stance',
    male: 'with athletic toned build, sharp defined facial structure, calm focused gaze, mouth closed, closed lips, and upright confident stance'
  },
  mature: {
    name: '成熟御姐',
    female: 'with sophisticated executive poise, graceful mature facial structure, mouth closed, closed lips, and commanding serene lookbook presence',
    male: 'with distinguished mature charisma, sharp masculine features, mouth closed, closed lips, and commanding executive posture'
  },
  cool: {
    name: '中性酷感',
    female: 'with modern androgynous edge, chic understated attitude, sharp bone structure, mouth closed, closed lips, and effortless lookbook posture',
    male: 'with contemporary streetwear edge, cool understated attitude, sharp jawline, mouth closed, closed lips, and effortless confident posture'
  }
};
...
const SCENES = {
  street: {
    ...
    buildPrompts: (gender = 'female', custom = '', _customScene = '', style = 'classic', customStylePrompt = '') => {
      ...
      return {
        krea_prompt: `a ${subj} standing full-length on a sunlit city street sidewalk with historic brownstone buildings, transfer the outfit, full body editorial fashion lookbook photography, head-to-toe framed with complete shoes and feet firmly planted on concrete sidewalk with realistic soft ground contact shadows beneath footwear, both arms straight down relaxed naturally at sides, both hands open and fully visible with natural five fingers clearly shown on each hand, serene composed expression, closed lips, natural directional sunlight casting soft ground shadows, authentic human skin texture with visible natural pores, fine skin lines, subtle peach fuzz, natural skin sheen, realistic subsurface scattering, natural catchlights in the eyes, tactile fabric weave and seam details, shot on 35mm lens, subtle organic film grain${extra}`,
        seg1_prompt: `A commercial lookbook fashion video faithful to the reference image: the identical ${subj} wearing the exact outfit from the reference image. Steady gimbal tracking shot at eye level: ${pro} takes slow, measured runway strides forward toward the camera along a sunlit urban asphalt sidewalk (1 step per second), both arms swaying naturally at sides with relaxed open hands. Calm composed lookbook expression with closed lips, subtle relaxed facial features. Natural fabric and leather drape and garment movement swaying organically with each step. Constant directional daylight, authentic textile details, soft circular background bokeh, stable camera framing${extra}.\n\nAudio: distant muffled city traffic hum, crisp footsteps on asphalt sidewalk, subtle soft rustle of clothing fabric swaying as ${pro} walks.`,
  ...
  studio: {
    ...
    buildPrompts: (gender = 'female', custom = '', _customScene = '', style = 'classic', customStylePrompt = '') => {
      ...
      const extra = custom ? `, ${custom}` : '';
      return {
        krea_prompt: `a professional ${subj} standing full-length in a clean minimalist studio against a neutral grey cyclorama backdrop, transfer the outfit, full body commercial catalogue lookbook photography, head-to-toe framed with complete shoes and feet firmly planted on matte studio floor with realistic soft ground contact shadows beneath footwear, both arms straight down relaxed naturally at sides, both hands open and fully visible with natural five fingers clearly shown on each hand, serene composed editorial expression, closed lips, diffuse softbox studio lighting, authentic human skin texture with visible natural pores, fine skin lines, subtle peach fuzz, natural skin sheen, realistic subsurface scattering on cheeks, natural catchlights in the eyes, tactile cloth texture and seam details, shot on 50mm lens, subtle organic film grain, soft contact shadows${extra}`,
        seg1_prompt: `A commercial lookbook fashion video faithful to the reference image: the identical ${subj} wearing the exact outfit from the reference image, situated against a neutral grey cyclorama studio backdrop. Smooth motorized camera dolly tracking backward at eye level: ${pro} takes slow, deliberate runway steps forward, both arms swaying naturally at sides with relaxed open hands, with calm poise and closed lips. Clean garment tailoring, natural cloth and leather physics, natural weave texture and subtle film grain, zero shadow pulsing. Dual softbox studio illumination with soft natural falloff${extra}.\n\nAudio: dead-quiet soundproof studio room tone, soft rhythmic footsteps on floor, subtle tactile rustle of garment cloth swaying.`,
        seg2_prompt: `Continuing seamlessly from the previous walk: the same ${subj} in the identical outfit smoothly slows ${pos} cadence and executes an elegant 45-degree exhibition turn, allowing the camera to inspect the side silhouette, collar construction, and rear garment cut, pausing with serene poise and closed lips. Tripod steady framing, softbox studio lighting with gentle shadow falloff, authentic catalogue aesthetic, stable facial features, stable anatomy${extra}.\n\nAudio: quiet soundproof studio room tone, soft shoe pivot on floor, quiet whisper of moving garment fabric.`
      };
    }
  },
  office: {
    ...
    buildPrompts: (gender = 'female', custom = '', _customScene = '', style = 'classic', customStylePrompt = '') => {
      ...
      const extra = custom ? `, ${custom}` : '';
      return {
        krea_prompt: `a ${subj} standing full-length in the grand entrance lobby of a modern glass corporate skyscraper, polished granite floors, transfer the outfit, full body executive lookbook photography, head-to-toe framed with complete shoes and feet firmly planted on polished granite floor with realistic soft ground contact shadows and gentle floor reflections beneath footwear, both arms straight down relaxed naturally at sides, both hands open and fully visible with natural five fingers clearly shown on each hand, composed executive poise, closed lips, morning architectural sunlight filtering through high glass curtain walls, authentic human skin texture with visible natural pores, fine skin lines, subtle peach fuzz, natural skin sheen, realistic subsurface scattering, natural catchlights in the eyes, tactile leather grain and fabric drape, shot on 35mm lens, subtle organic film grain${extra}`,
  ...
  boutique: {
    ...
    buildPrompts: (gender = 'female', custom = '', _customScene = '', style = 'classic', customStylePrompt = '') => {
      ...
      const extra = custom ? `, ${custom}` : '';
      return {
        krea_prompt: `a ${subj} standing full-length in a luxury designer concept boutique with polished Italian marble floors and minimalist brass fixtures, transfer the outfit, full body luxury retail lookbook photography, head-to-toe framed with complete shoes and feet firmly planted on polished marble with realistic soft ground contact shadows beneath footwear, both arms straight down relaxed naturally at sides, both hands open and fully visible with natural five fingers clearly shown on each hand, serene composed gaze, closed lips, warm 3200K architectural recessed spotlights with soft falloff, authentic human skin texture with visible natural pores, fine skin lines, subtle peach fuzz, natural skin sheen, realistic subsurface scattering, natural catchlights in the eyes, tactile fabric weave and leather grain, shot on 35mm lens, subtle organic film grain${extra}`,
        seg1_prompt: `A luxury retail commercial lookbook video faithful to the reference image: the identical ${subj} wearing the exact outfit from the reference image in a lavish warm-toned concept boutique with polished Italian marble floors. Smooth camera glide tracking backward at eye level: ${pro} walks gracefully forward with both arms swaying naturally at sides with relaxed open hands, a calm composed expression and closed lips. Warm 3200K architectural spotlights gently grazing fabric textures and clean seams. Fluid motion, perfectly locked anatomy, elegant posture${extra}.\n\nAudio: luxurious quiet boutique interior ambiance, subtle acoustic reverberation, crisp rhythmic footsteps clicking gently on polished marble floor, soft silky cloth rustle.`,
  ...
  outdoor: {
    ...
    buildPrompts: (gender = 'female', custom = '', _customScene = '', style = 'classic', customStylePrompt = '') => {
      ...
      const extra = custom ? `, ${custom}` : '';
      return {
        krea_prompt: `a ${subj} standing full-length in a lush sun-dappled botanical garden along a smooth stone paver pathway, blooming foliage, transfer the outfit, full body lifestyle lookbook photography, head-to-toe framed with complete shoes and feet firmly planted on stone pavers with realistic soft ground contact shadows beneath footwear, both arms straight down relaxed naturally at sides, both hands open and fully visible with natural five fingers clearly shown on each hand, peaceful serene expression, closed lips, natural outdoor daylight, soft dappled sunlight, authentic human skin texture with visible natural pores, fine skin lines, subtle peach fuzz, natural skin sheen, realistic subsurface scattering, natural catchlights in the eyes, tactile cloth folds and texture, shot on 35mm lens, subtle organic film grain${extra}`,
  ...
  cafe: {
    ...
    buildPrompts: (gender = 'female', custom = '', _customScene = '', style = 'classic', customStylePrompt = '') => {
      ...
      const extra = custom ? `, ${custom}` : '';
      return {
        krea_prompt: `a ${subj} standing full-length in a cozy Nordic-aesthetic cafe with warm timber oak interiors and large floor-to-ceiling sunlit windows, transfer the outfit, full body cozy editorial lookbook photography, head-to-toe framed with complete shoes and feet firmly planted on hardwood floor with realistic soft ground contact shadows beneath footwear, both arms straight down relaxed naturally at sides, both hands open and fully visible with natural five fingers clearly shown on each hand, relaxed serene expression, closed lips, warm natural window light with soft interior fill, authentic human skin texture with visible natural pores, fine skin lines, subtle peach fuzz, natural skin sheen, realistic subsurface scattering, natural catchlights in the eyes, tactile knit and fabric weave, shot on 35mm lens, subtle organic film grain${extra}`,
  ...
  custom: {
    ...
    buildPrompts: (gender = 'female', customPrompt = '', customScene = '', style = 'classic', customStylePrompt = '') => {
      ...
      return {
        krea_prompt: `a ${subj} standing full-length ${sceneDesc}, transfer the outfit, full body editorial lookbook photography, head-to-toe framed with complete shoes and feet firmly planted on ground with realistic soft ground contact shadows beneath footwear, both arms straight down relaxed naturally at sides, both hands open and fully visible with natural five fingers clearly shown on each hand, serene composed expression, closed lips, elegant confident posture, realistic lighting consistent with the environment, authentic human skin texture with visible natural pores, fine skin lines, subtle peach fuzz, natural skin sheen, realistic subsurface scattering, natural catchlights in the eyes, tactile fabric weave and seam details, shot on 35mm lens, subtle organic film grain${extra}`,
        seg1_prompt: `A commercial lookbook fashion showcase video faithful to the reference image: the ${subj} wearing the identical outfit, situated ${sceneDesc}. Smooth steady gimbal tracking shot at eye level: ${pro} walks forward at a measured natural cadence, both arms swaying naturally at sides with relaxed open hands, with calm confidence and closed lips toward the lens. Fabric drape, leather grain, and textile weave clearly visible, natural organic cloth physics. Natural ambient lighting consistent with the environment${extra}.\n\nAudio: natural atmospheric ambiance matching the acoustic surroundings, subtle rhythmic footsteps, soft fabric rustle as ${pro} moves.`,
        seg2_prompt: `Continuing seamlessly from the previous shot: the same ${subj} in the identical outfit situated ${sceneDesc} slows ${pos} stride and turns 45 degrees to showcase the silhouette, fabric flow, leather grain, and rear tailoring of the clothing, pausing naturally with a calm composed glance toward the lens, closed lips and serene poise. Steady smooth camera pan revealing fabric weave and flow. Harmonious natural lighting, natural textile details, stable facial features, stable anatomy${extra}.\n\nAudio: continuous atmospheric ambient background, gentle fabric movement sound, subtle environmental breeze.`
      };
    }
  }
};
  ...
  try {
    ...
    if (task.model_image) {
      ...
      if (fs.existsSync(srcModelPath)) {
        ...
        kreaWf['9']['inputs']['prompt'] = `transfer the clothing and outfit from the first reference image onto the ${modelGenderLabel} in the second reference image, strictly preserving their exact facial features, facial identity, eye shape, nose shape, and hairstyle, full body editorial lookbook photography, head-to-toe framed with complete shoes and feet firmly planted on ground with realistic soft ground contact shadows beneath footwear, both arms straight down relaxed naturally at sides, both hands open and fully visible with natural five fingers clearly shown on each hand, standing ${sceneEnv}, serene composed expression, closed lips, authentic human skin texture with visible natural pores, fine skin lines, subtle peach fuzz, natural skin sheen, realistic subsurface scattering, natural catchlights in the eyes, tactile fabric weave and seam details, shot on 35mm lens, subtle organic film grain${cleanCustom ? ', ' + cleanCustom : ''}`;
      }
      ...
      if (fs.existsSync(srcScenePath)) {
        ...
        kreaWf['9']['inputs']['prompt'] = `a ${subj} standing full-length in the background environment from the first reference image, wearing the exact clothing and outfit from the second reference image, full body editorial lookbook photography, head-to-toe framed with complete shoes and feet firmly planted on ground with realistic soft ground contact shadows beneath footwear, both arms straight down relaxed naturally at sides, both hands open and fully visible with natural five fingers clearly shown on each hand, serene composed expression, closed lips, realistic illumination matched to the background environment, authentic human skin texture with visible natural pores, fine skin lines, subtle peach fuzz, natural skin sheen, realistic subsurface scattering, natural catchlights in the eyes, tactile fabric weave and seam details, shot on 35mm lens, subtle organic film grain${cleanCustom ? ', ' + cleanCustom : ''}`;
      }
    }
